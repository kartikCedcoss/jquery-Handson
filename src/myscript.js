...
$("p").
prepend
("YES!");//Use a jQuery method to insert the text "YES!" at the beginning of a <p> element.
...
$("p").
addClass
("important"); //Use a jQuery method to add the "important" class to a <p> element.



$("p").
addClass
("important test"); //Use a jQuery method to add both the "important" and "test" class to a <p> element.

$("p").
removeClass
("important"); //Use a jQuery method to remove the "important" class from a <p> element.
...
(function(){
  $(this).
toggleClass
("important");}); //Use a jQuery method to toggle between adding and removing the "important" class from the <p> element on click.
